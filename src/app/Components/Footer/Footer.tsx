...
function Footer() {
  return (
    <div className=" text-center">
      ...
      <div className="bg-[#FF9F0D] flex flex-wrap gap-6 justify-center md:justify-between items-center py-4 px-6">
        <p className="text-sm md:text-base">Copyright © 2025 by Ayesha Rana. All Rights Reserved.</p>
